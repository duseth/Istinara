...
import {DictionaryList, LanguageContext} from "../../bin/context/Language";
...
export function TeamSupervisor({tid}) {
    const languageContext = useContext(LanguageContext);
    return languageContext.dictionary["team"]["supervisor"][tid] || tid;
}

export function TeamDeveloper({tid}) {
    const languageContext = useContext(LanguageContext);
    return languageContext.dictionary["team"]["developer"][tid] || tid;
}

export function TeamAuthor({tid}) {
    const languageContext = useContext(LanguageContext);
    return languageContext.dictionary["team"]["author"][tid] || tid;
}

export function TeamArtist({tid}) {
    const languageContext = useContext(LanguageContext);
    return languageContext.dictionary["team"]["artist"][tid] || tid;
}
...
// Article types
export function ArticleTypesForm({tid}) {
    const languageContext = useContext(LanguageContext);
    return languageContext.dictionary["article_types"]["form"][tid] || tid;
}

export function ArticleTypesCreateForm({tid}) {
    const languageContext = useContext(LanguageContext);
    return languageContext.dictionary["article_types"]["form"]["create"][tid] || tid;
}

export function ArticleTypesUpdateForm({tid}) {
    const languageContext = useContext(LanguageContext);
    return languageContext.dictionary["article_types"]["form"]["update"][tid] || tid;
}

export function ArticleTypesDeleteForm({tid}) {
    const languageContext = useContext(LanguageContext);
    return languageContext.dictionary["article_types"]["form"]["delete"][tid] || tid;
}
