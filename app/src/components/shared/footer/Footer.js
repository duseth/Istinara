        ...
        <footer className="site-footer">
            <div className="container">
                <div className="row text-center">
                    <svg width="320" height="80" viewBox="0 0 320 107.31933314070741" className="footer-svg">
                        <defs id="SvgjsDefs1502"></defs>
                        <g id="SvgjsG1503"
                           transform="matrix(1.1924369338126177,0,0,1.1924369338126177,-9.627118733501554,-5.962184669063088)"
                           fill="#ffffff">
                        ...
                        <g id="SvgjsG1504"
                           transform="matrix(1.1098778382446535,0,0,1.1098778382446535,115.11653740587732,25.72364133278824)"
                           fill="#ffffff">
                            <path
                ...
                <div className="row text-center">
                    <div className="link-text col">
                        <a className="link" href="/about">
                            <FooterLink tid="about"/>
                        </a>
                    </div>
                    <div className="link-text col">
                        <a className="link" href="/">
                            <FooterLink tid="information"/>
                        </a>
                    </div>
                    <div className="link-text col">
                        <a className="link" href="/contacts">
                            <FooterLink tid="contacts"/>
                        </a>
                    </div>
                </div>
                <hr/>
            ...
            <div className="container">
                <div className="text-center">
                    ...
                    <p className="copyright-text">&copy; Istinara, 2022 <FooterText tid="rights"/></p>
                </div>
            </div>
        </footer>
    );
